...
abstract final class MockData {
  ...
  static const priceTiers = [
    PriceTier(
      ...
      valueProp:
          'Covers cover charge. Includes 1 complementary speakeasy cocktail.',
    ),
    PriceTier(
      id: 'tier-60',
      duration: 60,
    ...
    PriceTier(
      ...
      valueProp:
          'VIP table lounge reservation. Secret room access + double points rate.',
    ),
  ];
  ...
  static const timePackages = [
    TimePackage(
      ...
      minutes: 90,
      label: 'QUICK ESCAPE',
      tagline: 'Your time starts now. · 2 drinks',
      pricePeso: 699,
      includedDrinks: 2,
    ),
    TimePackage(
      ...
      tagline: 'Every second counts. · 4 drinks',
      pricePeso: 999,
      includedDrinks: 4,
      popular: true,
    ),
    TimePackage(
      ...
      minutes: 240,
      label: 'AFTER HOURS',
      tagline: 'Extend your time. · 5 drinks',
      pricePeso: 1299,
      includedDrinks: 5,
    ),
    TimePackage(
      ...
      minutes: 480,
      label: 'UNLIMITED',
      tagline: 'Invest your time wisely. · Until closing',
      pricePeso: 1799,
    ),
  ];
  ...
  static const miniGames = [
    ...
    MiniGame(
      ...
      description:
          'Solve the rotary padlock puzzle to unlock the VIP cellar lounge.',
      points: 15,
      icon: 'cipher',
    ),
    MiniGame(
      ...
      description:
          'Locked cabinet holding high-value complimentary bottle service tickets.',
      points: 100,
      icon: 'mystery',
      locked: true,
